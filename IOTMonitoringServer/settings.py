...
ALLOWED_HOSTS = ["localhost", "ec2-54-80-91-182.compute-1.amazonaws.com"]
...
DATABASES = {
    "default": {
        ...
        "HOST": "ec2-18-234-71-47.compute-1.amazonaws.com",  # Dirección IP de la base de datos
...
MQTT_HOST = "ec2-34-238-146-14.compute-1.amazonaws.com"
